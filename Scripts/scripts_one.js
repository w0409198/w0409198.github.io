...
function show_web_portfolio() {
    ...
    target_element_1.innerHTML = 'Throughout my first semester Web Development class, we studied a wide range of topics, from the basics of setting the title tag, to creating a responsive design. As the final' +
        ...
        '<p><img src="images/work_samples/code_snippet_one.png" align="left" width="400px" height="200px" border="2px white">This code snippet is the behind the scenes of the text on this page.' +
        ...
        '<br><br>' +
        '<p><img src="images/work_samples/Full_Site.png" align="right" width="400px" height="200px" border="2px white"> </p>' +
